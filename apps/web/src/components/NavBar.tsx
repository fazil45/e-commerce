  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      >
        ...
        <NavLink to='/' className={"py-2 pl-6 border-t"} onClick={() => setVisible(false)} >HOME</NavLink>
        <NavLink to='/collection' className={"py-2 pl-6 border-t"} onClick={() => setVisible(false)} >COLLECTION</NavLink>
        <NavLink to='/about' className={"py-2 pl-6 border-t"} onClick={() => setVisible(false)} >ABOUT</NavLink>
        <NavLink to='/contact' className={"py-2 pl-6 border-y"} onClick={() => setVisible(false)} >CONTACT</NavLink>
